    ...
    <main className="mx-auto w-full max-w-6xl px-6 py-14">
      <div className="mx-auto max-w-2xl rounded-xl border border-zinc-200 bg-white p-10 text-center">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          <Link
            href="/wishlist"
            className="inline-flex items-center justify-center rounded-md border border-zinc-200 bg-white px-6 py-3 text-sm font-medium text-zinc-900 transition-colors hover:border-[#722F37] hover:bg-[#722F37]/10 hover:text-[#722F37]"
          >
            Xem Yêu thích
          </Link>
        </div>
